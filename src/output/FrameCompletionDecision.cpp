...
bool Monitor::pendingCommitIsCurrent(uint64_t commitGeneration, uint64_t renderGeneration, bool newSchedulingEnabled) {
    return newSchedulingEnabled && commitGeneration == renderGeneration;
}
